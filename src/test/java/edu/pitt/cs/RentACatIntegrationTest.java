...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		// Execution steps
		try {
			Method getCat = r.getClass().getDeclaredMethod("getCat");
			getCat.setAccessible(true);
			Cat retVal = (Cat) getCat.invoke(r, 2);
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String cats = r.listCats();
		assertEquals("ID 1. Jennyanydots", c1.toString());
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse(rent);
		assertTrue(c2.getRented());
		assertEquals("Old Deuteronomy has been rented." + newline + "Sorry, Old Deuteronomy is not here!" + newline,
				out.toString());
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue(returned);
		assertEquals("Old Deuteronomy has been rented." + newline + "Welcome back, Old Deuteronomy!" + newline,
				out.toString());
	}
